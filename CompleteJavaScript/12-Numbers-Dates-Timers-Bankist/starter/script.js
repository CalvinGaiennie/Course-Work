...
const startLogOutTimer = function () {
  const tick = function () {
    ...
    //Whe 0 seconds, stop timer and log out user
    if (time === 0) {
      clearInterval(timer);
...
//even or odd
// divide by 2 with no remainder and its even
console.log(6 % 2);
console.log(7 % 2);
...
// console.log(new Date('Aug 26 2024 22:09:39'));
// console.log(new Date('December 24, 2015'));
// console.log(new Date(account1.movementsDates[0]));
// console.log(new Date(2037, 10, 19, 15, 23, 5));
// console.log(new Date(2037, 10, 50, 15, 23, 5));
